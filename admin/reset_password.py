...
def reset_password_page(content: ft.Column, page: ft.Page, username: Optional[str]):
    """
    Dedicated page for resetting a password for a specific user.
    """
    ...
    new_password = ft.TextField(label="New Password", password=True, can_reveal_password=True, expand=True)
